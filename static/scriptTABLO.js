...
сейчас вам доступна акция «Фрибет 15% от депозита» 😍<br><br>
Чтобы получить фрибет, вам потребуется пополнить счёт на сумму от 300 рублей в течение 4 дней с момента получения предложения.<br>
После пополнения вам будет начислен фрибет в размере 15% от суммы депозита, но не более 20 000 рублей.<br><br>

Фрибет можно использовать на спортивные события с коэффициентом до 3.00 в течение 3 дней — на сайте или в мобильном приложении.<br><br>

Подробные правила: https://pari.ru/pages/rej_fb15_av 
`
