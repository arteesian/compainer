...
document.getElementById('personal-actions').addEventListener('click', () => {
  window.location.href = 'http://127.0.0.1:8100/admin_personal';
});
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const profileBtn   = document.querySelector('.profile-button-admin');
  const profileMenu  = document.getElementById('profile-menu');
  //чтобы не менять код - конкретно в этом файле adminItem это кнопка "Выйти из админки"
